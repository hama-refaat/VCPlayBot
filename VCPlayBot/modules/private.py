    ...
    client.send_message(message.chat.id,
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "📲 Updates", url=f"https://t.me/hama_roberts"), 
                    InlineKeyboardButton(
                        "💬 Support", url=f"https://t.me/teamkurdishchat")
                ],[
                    InlineKeyboardButton(
                        "📡 Channel", url=f"https://t.me/xawnakam_lm")
                ]
            ]
        ),
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "💬 Support Chat", url=f"https://t.me/teamkurdishchat"
                    )
                ]
            ]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '📲 Updates', url=f"https://t.me/hama_roberts"),
             InlineKeyboardButton(text = '💬 Support', url=f"https://t.me/teamkurdishchat")],
            [InlineKeyboardButton(text = '📡Channel ', url=f"https://t.me/xawnakam_lm")],
